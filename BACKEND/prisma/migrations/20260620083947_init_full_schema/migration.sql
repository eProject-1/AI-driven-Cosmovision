...
-- CreateEnum
CREATE TYPE "IntentType" AS ENUM ('PLANET_INFO', 'CONSTELLATION_INFO', 'STARGAZING_RECOMMENDATION', 'WEATHER_CHECK', 'OBSERVATORY_SEARCH', 'GENERAL_ASTRONOMY', 'NEWS', 'GUIDE', 'IMAGE_RECOGNITION', 'FAVORITE', 'UNKNOWN');
...
CREATE TABLE "planets" (
    ...
    "distanceFromEarthKm" DOUBLE PRECISION,
...
CREATE TABLE "constellations" (
    ...
    "rightAscension" TEXT,
    "declination" TEXT,
    "areaSqDeg" DOUBLE PRECISION,
    "visibleLatitudes" TEXT,
    "mainStars" INTEGER,
    "brightestStar" TEXT,
    "bestMonth" TEXT,
    "bestSeason" TEXT,
    ...
    "mapUrl" TEXT,
    "description" TEXT,
    "mythologicalOrigin" TEXT,
    "aiMythology" TEXT,
    "aiFacts" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "aiObserverTip" TEXT,
    "isVisible" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "recommendations" (
    ...
    "nearbyObservatories" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "aiSuggestion" TEXT,
...
CREATE TABLE "observatories" (
    ...
    "lightPollutionScore" DOUBLE PRECISION,
    "skyQualityScore" DOUBLE PRECISION,
...
-- CreateIndex
CREATE INDEX "recommendations_locationKey_expiresAt_idx" ON "recommendations"("locationKey", "expiresAt");
...
-- CreateIndex
CREATE UNIQUE INDEX "weather_cache_latRounded_lonRounded_key" ON "weather_cache"("latRounded", "lonRounded");
