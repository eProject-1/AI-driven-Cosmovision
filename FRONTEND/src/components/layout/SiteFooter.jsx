    ...
    <footer className="relative z-10 border-t border-foreground/10 bg-background/60 backdrop-blur-sm">
      <div className="mx-auto max-w-7xl px-8 md:px-14 py-16 md:py-20">
        <div className="grid gap-12 md:grid-cols-[1.2fr_1fr_1fr]">
          <div>
            <Link to="/" className="font-display text-[11px] font-medium tracking-[0.4em] uppercase text-foreground/80">
              SPACEVERSE
            </Link>
            <p className="mt-6 max-w-sm text-sm font-light leading-relaxed text-foreground/50">
              A cinematic field guide to the Solar System and the sky above it.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-6 space-y-3">
              {sections.map((section) => (
                <li key={section.to}>
                  <Link to={section.to} className="text-sm font-light text-foreground/60 hover:text-foreground transition-colors duration-500">
                    {section.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <p className="mt-6 text-sm font-light leading-relaxed text-foreground/55">
              Built with curiosity. Imagery courtesy of NASA, ESA, and the open-source astronomy community.
            </p>
          </div>
        </div>
